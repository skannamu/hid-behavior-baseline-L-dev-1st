...
SAVE_PATH = os.path.join(CHECKPOINT_DIR, "recon_hid_v2_round1.pt")

RESULT_DIR = "results/recon_hid_v2_round1"
TRAIN_HISTORY_CSV = os.path.join(RESULT_DIR, "train_history_recon_hid_v2_round1.csv")
...
def main():
    ...
    print("\n===== TRAIN ReCon-HID v2 Round1 START =====")
    ...
    print(f"Adaptive train path : {ADAPTIVE_V5_TRAIN_PATH}")
    print("===========================================\n")
    ...
    print("\n===== TRAIN ReCon-HID v2 Round1 DONE =====")
