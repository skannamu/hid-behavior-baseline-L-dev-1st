...
SAVE_PATH = os.path.join(CHECKPOINT_DIR, "recon_hid_v2_round2.pt")

RESULT_DIR = "results/recon_hid_v2_round2"
TRAIN_HISTORY_CSV = os.path.join(RESULT_DIR, "train_history_recon_hid_v2_round2.csv")
...
def main():
    ...
    print("\n===== TRAIN ReCon-HID v2 Round2 START =====")
            ...
            torch.save(
                {
                    ...
                    "round": 2,
                    "description": (
                        "Round2 detector trained with cumulative hard negatives: "
                        "FeatureGuideHumanMimic v4, AdaptiveMimic v5 train, "
                        "and D1-guided AdaptiveMimic v6 OR90 bypass train."
                    ),
                },
                SAVE_PATH,
            )
    ...
    print("\n===== TRAIN ReCon-HID v2 Round2 DONE =====")
