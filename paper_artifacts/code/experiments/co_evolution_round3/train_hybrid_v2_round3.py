...
ADAPTIVE_V5_TRAIN_PATH = "data/attack/AdaptiveMimic_v5_constrained_train"
ADAPTIVE_V6_TRAIN_PATH = "data/attack/AdaptiveMimic_v6_D1_OR90_bypass_train"
ADAPTIVE_V7_TRAIN_PATH = "data/attack/AdaptiveMimic_v7_D2_OR90_bypass_train"

SCALER_PATH = "checkpoints/scaler.pkl"

CHECKPOINT_DIR = "checkpoints"
SAVE_PATH = os.path.join(CHECKPOINT_DIR, "recon_hid_v2_round3.pt")

RESULT_DIR = "results/recon_hid_v2_round3"
TRAIN_HISTORY_CSV = os.path.join(RESULT_DIR, "train_history_recon_hid_v2_round3.csv")
...
def main():
    ...
    samples = [
        ...
        {
            "group": "AdaptiveMimic_v5_constrained_train",
            "path": ADAPTIVE_V5_TRAIN_PATH,
            "label": 1,
        },
        {
            "group": "AdaptiveMimic_v6_D1_OR90_bypass_train",
            "path": ADAPTIVE_V6_TRAIN_PATH,
            "label": 1,
        },
        {
            "group": "AdaptiveMimic_v7_D2_OR90_bypass_train",
            "path": ADAPTIVE_V7_TRAIN_PATH,
            "label": 1,
        },
    ]
    ...
    print("\n===== TRAIN ReCon-HID v2 Round3 START =====")
    ...
    print(f"FeatureGuide path   : {FEATURE_GUIDE_DATA_PATH}")
    print(f"V5 train path       : {ADAPTIVE_V5_TRAIN_PATH}")
    print(f"V6 train path       : {ADAPTIVE_V6_TRAIN_PATH}")
    print(f"V7 train path       : {ADAPTIVE_V7_TRAIN_PATH}")
    print("===========================================\n")
            ...
            torch.save(
                {
                    ...
                    "train_groups": [
                        "normal",
                        "FeatureGuideHumanMimic_v4",
                        "AdaptiveMimic_v5_constrained_train",
                        "AdaptiveMimic_v6_D1_OR90_bypass_train",
                        "AdaptiveMimic_v7_D2_OR90_bypass_train",
                    ],
                    "excluded_from_train": [
                        "AdaptiveMimic_v5_constrained_test",
                        "AdaptiveMimic_v6_D1_OR90_bypass_test",
                        "AdaptiveMimic_v7_D2_OR90_bypass_test",
                    ],
                    "loss_weights": {
                    ...
                    "round": 3,
                    "description": (
                        "Round3 detector trained with cumulative hard negatives: "
                        "FeatureGuideHumanMimic v4, AdaptiveMimic v5 train, "
                        "D1-guided AdaptiveMimic v6 OR90 bypass train, "
                        "and D2-guided AdaptiveMimic v7 OR90 bypass train."
                    ),
                },
                SAVE_PATH,
            )
    ...
    print("\n===== TRAIN ReCon-HID v2 Round3 DONE =====")
