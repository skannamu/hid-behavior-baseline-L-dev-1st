...
ADAPTIVE_V6_TRAIN_PATH = "data/attack/RandomMatched_v6_train"
ADAPTIVE_V7_TRAIN_PATH = "data/attack/RandomMatched_v7_train"

SCALER_PATH = "checkpoints/scaler.pkl"

CHECKPOINT_DIR = "checkpoints"
SAVE_PATH = os.path.join(CHECKPOINT_DIR, "recon_hid_v2_round3_random_matched.pt")

RESULT_DIR = "results/recon_hid_v2_round3_random_matched"
TRAIN_HISTORY_CSV = os.path.join(RESULT_DIR, "train_history_recon_hid_v2_round3_random_matched.csv")
...
def main():
    ...
    samples = [
        ...
        {
            "group": "RandomMatched_v6_train",
            "path": ADAPTIVE_V6_TRAIN_PATH,
            "label": 1,
        },
        {
            "group": "RandomMatched_v7_train",
            ...
            torch.save(
                {
                    ...
                    "train_groups": [
                        ...
                        "RandomMatched_v6_train",
                        "RandomMatched_v7_train",
                    ],
                    "excluded_from_train": [
